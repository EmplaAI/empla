# empla — Future Vision & Ideas

> **Origin:** This was the original ARCHITECTURE.md (Oct 2025) — the founding
> vision for empla. Much of it remains aspirational. For what's actually built
> today, see `ARCHITECTURE.md` in the repo root.
>
> **Purpose:** Reference for long-term direction. Ideas here are NOT commitments —
> they're concepts worth revisiting as the platform matures.
>
> Last Updated: 2025-10-25 (original), preserved 2026-03-20
...
- **Add**: Redis when working memory requires a distributed cache
...
## Additional Concepts (from original README)

The following ideas were captured in the original README and represent
interaction patterns and capabilities worth building toward.

### Shadow Mode & Behavioral Cloning

New employees shadow human mentors before working independently:
- **Shadow mode** — observe mentor's emails, meetings, tasks, decisions
- **Behavioral cloning** — learn email tone, meeting facilitation style, sales methodology
- **Thought cloning** — not just *what* they decided but *why* (decision reasoning)
- **RLHF feedback loop** — humans review work, employee learns from corrections

This solves the cold-start problem: employees are smart and aligned from day one.

### Real Meeting Participation

Unlike agents that just transcribe, empla employees fully participate:
- Join with video (AI avatar) and audio
- Present with screen sharing
- Listen and respond in real-time (WebRTC + voice synthesis + STT)
- Handle Q&A and objections
- Send follow-up notes

Technical: WebRTC audio/video + ElevenLabs/Azure voice + Whisper STT + screen sharing

### Natural Interaction (No Special Interface)

Interact with digital employees through existing workflows:
- **Email them directly** — jordan@company.com receives and responds like any colleague
- **Slack/Teams mentions** — @jordan answers in channel with context
- **Task delegation** — assign work via task management tools, employee acknowledges and executes
- **Feedback** — rate employee actions, they learn and adapt
- **Performance dashboard** — real-time metrics, activity log, goal progress

### Team Coordination (A2A Protocol)

Digital employees collaborate with each other:
- **Seamless handoffs** — Sales AE closes deal → CSM takes over with full context
- **Collaborative workflows** — PM + Sales + CSM coordinate on product launches
- **Shared knowledge** — one employee learns "video outreach gets 3x response" → all benefit
- **Team self-organization** — specialists focus on strengths, redistribute by capacity

Built on Agent2Agent (A2A) Protocol — Linux Foundation standard for agent communication.

### Employee Lifecycle

Creating a digital employee feels like hiring:
- **Real identity** — jordan@company.com (provisioned email, calendar, chat)
- **Employee profile** — role, department, manager, start date, skills
- **Onboarding phases** — shadow → assisted → autonomous
...
### Additional Employee Types (Planned)

- **Product Manager** — usage analysis, roadmap management, launch coordination
- **Recruiter** — sourcing, outreach, screening, coordination
- **Executive Assistant** — calendar management, email triage, brief preparation

---

**Document History:**
- 2025-10-25: Initial architecture v0.1
- 2026-03-20: Preserved as future-vision.md, added README concepts

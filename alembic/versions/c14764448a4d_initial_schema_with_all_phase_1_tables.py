...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "name", sa.String(length=200), nullable=False, comment="Organization display name"
        ),
        sa.Column(
            "slug",
            sa.String(length=50),
    ...
    # Create audit_log table (depends on tenants)
    op.create_table(
        "audit_log",
        sa.Column(
            "actor_type",
        ...
        sa.Column(
            "actor_id", sa.UUID(), nullable=False, comment="Actor UUID (employee/user/system)"
        ),
        sa.Column(
            "action_type",
        ...
        sa.CheckConstraint(
            "actor_type IN ('employee', 'user', 'system')", name="ck_audit_log_actor_type"
        ),
    ...
    op.create_index(
        "idx_audit_actor", "audit_log", ["actor_type", "actor_id", "occurred_at"], unique=False
    )
    op.create_index(
        "idx_audit_resource",
        "audit_log",
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "status IN ('onboarding', 'active', 'paused', 'terminated')", name="ck_employees_status"
        ),
    ...
    op.create_table(
        "beliefs",
        sa.Column(
            "employee_id", sa.UUID(), nullable=False, comment="Employee this belief belongs to"
        ),
        sa.Column(
            "belief_type",
            sa.String(length=20),
        ...
        sa.Column(
            "subject", sa.String(length=200), nullable=False, comment="What the belief is about"
        ),
        sa.Column(
            "predicate", sa.String(length=200), nullable=False, comment="Property or relation"
        ),
        sa.Column(
            "object",
            postgresql.JSONB(astext_type=sa.Text()),
    ...
    op.create_table(
        "employee_goals",
        sa.Column(
            "employee_id", sa.UUID(), nullable=False, comment="Employee this goal belongs to"
        ),
        sa.Column(
            "goal_type",
            sa.String(length=20),
    ...
    op.create_index(
        op.f("ix_employee_goals_employee_id"), "employee_goals", ["employee_id"], unique=False
    )
    op.create_index(
        op.f("ix_employee_goals_tenant_id"), "employee_goals", ["tenant_id"], unique=False
    )
    op.create_table(
        "memory_episodes",
        sa.Column(
        ...
        sa.Column(
            ...
            sa.String(length=500),
            nullable=False,
            comment="Human-readable episode summary",
        ),
        sa.Column(
            "content",
            postgresql.JSONB(astext_type=sa.Text()),
            nullable=False,
            comment="Full episode data",
        ),
        sa.Column(
            "participants",
            sa.ARRAY(sa.String()),
    ...
    op.create_index(
        "idx_episodes_type",
        "memory_episodes",
        ["employee_id", "episode_type"],
        unique=False,
        postgresql_where=sa.text("deleted_at IS NULL"),
    )
    op.create_index(
        op.f("ix_memory_episodes_employee_id"), "memory_episodes", ["employee_id"], unique=False
    )
    op.create_index(
        op.f("ix_memory_episodes_tenant_id"), "memory_episodes", ["tenant_id"], unique=False
    )
    op.create_table(
        "memory_procedural",
        sa.Column(
        ...
        sa.Column(
            ...
            sa.String(length=500),
            nullable=False,
            comment="Human-readable procedure description",
        ),
        sa.Column(
            "procedure_type",
            sa.String(length=20),
    ...
    op.create_index(
        op.f("ix_memory_procedural_employee_id"), "memory_procedural", ["employee_id"], unique=False
    )
    op.create_index(
        op.f("ix_memory_procedural_tenant_id"), "memory_procedural", ["tenant_id"], unique=False
    )
    op.create_table(
        "memory_semantic",
        sa.Column(
        ...
        sa.Column(
            ...
            nullable=False,
            comment="Predicate (relation or property)",
        ),
        ...
        sa.Column(
            "source", sa.String(length=200), nullable=True, comment="Where this fact came from"
        ),
        sa.Column(
            "verified",
            sa.Boolean(),
    ...
    op.create_index(
        "idx_semantic_fts",
        "memory_semantic",
        [sa.text("to_tsvector('english', subject || ' ' || predicate || ' ' || object)")],
        unique=False,
        postgresql_using="gin",
        postgresql_where=sa.text("deleted_at IS NULL"),
    )
    ...
    op.create_index(
        "idx_semantic_type",
        "memory_semantic",
        ["employee_id", "fact_type"],
        unique=False,
        postgresql_where=sa.text("deleted_at IS NULL"),
    )
    op.create_index(
        op.f("ix_memory_semantic_employee_id"), "memory_semantic", ["employee_id"], unique=False
    )
    op.create_index(
        op.f("ix_memory_semantic_tenant_id"), "memory_semantic", ["tenant_id"], unique=False
    )
    op.create_table(
        "memory_working",
        sa.Column(
    ...
    op.create_index(
        op.f("ix_memory_working_employee_id"), "memory_working", ["employee_id"], unique=False
    )
    op.create_index(
        op.f("ix_memory_working_tenant_id"), "memory_working", ["tenant_id"], unique=False
    )
    op.create_table(
        "metrics",
        sa.Column(
        ...
        sa.CheckConstraint(
            "metric_type IN ('counter', 'gauge', 'histogram')", name="ck_metrics_metric_type"
        ),
        sa.ForeignKeyConstraint(["employee_id"], ["employees.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["tenant_id"], ["tenants.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        ...
        "metrics",
        ["employee_id", "metric_name", "timestamp"],
        unique=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "new_value", postgresql.JSONB(astext_type=sa.Text()), nullable=True, comment="New value"
        ),
    ...
    op.create_index(
        "idx_belief_history_belief", "belief_history", ["belief_id", "changed_at"], unique=False
    )
    op.create_index(
        "idx_belief_history_employee", "belief_history", ["employee_id", "changed_at"], unique=False
    )
    op.create_index("idx_belief_history_tenant", "belief_history", ["tenant_id"], unique=False)
    op.create_index(
        op.f("ix_belief_history_belief_id"), "belief_history", ["belief_id"], unique=False
    )
    op.create_index(
        op.f("ix_belief_history_employee_id"), "belief_history", ["employee_id"], unique=False
    )
    op.create_index(
        op.f("ix_belief_history_tenant_id"), "belief_history", ["tenant_id"], unique=False
    )
    op.create_table(
        "employee_intentions",
        sa.Column(
            "employee_id", sa.UUID(), nullable=False, comment="Employee this intention belongs to"
        ),
        sa.Column(
            "goal_id",
            sa.UUID(),
        ...
        sa.Column(
            ...
            sa.String(length=500),
            nullable=False,
            comment="Human-readable intention description",
        ),
        sa.Column(
            "plan",
            postgresql.JSONB(astext_type=sa.Text()),
    ...
    op.create_index(
        op.f("ix_employee_intentions_employee_id"),
        "employee_intentions",
        ["employee_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_employee_intentions_goal_id"), "employee_intentions", ["goal_id"], unique=False
    )
    op.create_index(
        op.f("ix_employee_intentions_tenant_id"), "employee_intentions", ["tenant_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_intentions_tenant",
        table_name="employee_intentions",
        postgresql_where=sa.text("deleted_at IS NULL"),
    )
    op.drop_index(
        "idx_intentions_status",
    ...
    op.drop_index(
        "idx_beliefs_updated", table_name="beliefs", postgresql_where=sa.text("deleted_at IS NULL")
    )
    op.drop_index(
        "idx_beliefs_unique_subject_predicate",
        table_name="beliefs",
    ...
    op.drop_index(
        "idx_beliefs_tenant", table_name="beliefs", postgresql_where=sa.text("deleted_at IS NULL")
    )
    op.drop_index(
        "idx_beliefs_subject", table_name="beliefs", postgresql_where=sa.text("deleted_at IS NULL")
    )
    op.drop_index(
        "idx_beliefs_employee", table_name="beliefs", postgresql_where=sa.text("deleted_at IS NULL")
    )
    op.drop_index(
        "idx_beliefs_confidence",
        table_name="beliefs",
    ...
    op.drop_index(
        "idx_employees_role", table_name="employees", postgresql_where=sa.text("deleted_at IS NULL")
    )
    op.drop_index(
        "idx_employees_lifecycle",
        table_name="employees",
    ...
    op.drop_index(
        "idx_users_tenant", table_name="users", postgresql_where=sa.text("deleted_at IS NULL")
    )
    op.drop_index(
        "idx_users_email", table_name="users", postgresql_where=sa.text("deleted_at IS NULL")
    )
    op.drop_table("users")
    # Drop audit_log before tenants (audit_log has FK to tenants)
    ...
    # Drop tenants last (no dependencies on it remaining)
    op.drop_index(
        "idx_tenants_status", table_name="tenants", postgresql_where=sa.text("deleted_at IS NULL")
    )
    op.drop_index(
        "idx_tenants_slug", table_name="tenants", postgresql_where=sa.text("deleted_at IS NULL")
    )
